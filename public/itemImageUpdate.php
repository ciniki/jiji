...
function ciniki_jiji_itemImageUpdate(&$ciniki) {
    ...
    $rc = ciniki_jiji_checkAccess($ciniki, $args['tnid'], 'ciniki.jiji.itemImageUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.jiji.itemimage', $args['itemimage_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
